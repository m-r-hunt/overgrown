...
var inputs := {
	...
	CONTROL_TYPE.JOY1: {
		...
		"p%s_interact": [joy_press(0, JOY_XBOX_A), joy_press(0, JOY_R)],
		"p%s_dash": [joy_press(0, JOY_XBOX_B), joy_press(0, JOY_L)],
	...
	CONTROL_TYPE.JOY2: {
		...
		"p%s_interact": [joy_press(1, JOY_XBOX_A), joy_press(1, JOY_R)],
		"p%s_dash": [joy_press(1, JOY_XBOX_B), joy_press(1, JOY_L)],
	...
	CONTROL_TYPE.JOY3: {
		...
		"p%s_interact": [joy_press(2, JOY_XBOX_A), joy_press(2, JOY_R)],
		"p%s_dash": [joy_press(2, JOY_XBOX_B), joy_press(2, JOY_L)],
	...
	CONTROL_TYPE.JOY4: {
		...
		"p%s_interact": [joy_press(3, JOY_XBOX_A), joy_press(3, JOY_R)],
		"p%s_dash": [joy_press(3, JOY_XBOX_B), joy_press(3, JOY_L)],
	...
	CONTROL_TYPE.JOY5: {
		...
		"p%s_interact": [joy_press(4, JOY_XBOX_A), joy_press(4, JOY_R)],
		"p%s_dash": [joy_press(4, JOY_XBOX_B), joy_press(4, JOY_L)],
